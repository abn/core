...
from poetry.core.utils._compat import OrderedDict  # noqa
...
class Locker(object):
    ...
    def _lock_packages(self, packages):  # type: (List[Package]) -> List[Dict[str, Any]]
        locked = []
    ...
    def _load_package(self, info):  # type: (Data) -> Package
